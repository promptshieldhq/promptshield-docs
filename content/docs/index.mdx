...
**Prometheus metrics + Grafana dashboard**: Built-in `/metrics` endpoint. A 26-panel Grafana dashboard ships in `deploy/` covering request rate, p50/p95/p99 latency, token burn by model, block rate, and error rate. No PromQL needed.
